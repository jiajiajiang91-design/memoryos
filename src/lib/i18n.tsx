...
const DICT: Record<string, Entry> = {
  ...
  "entryLib.graphHint": { zh: "相连的记忆聚成一团，孤立的散在外围。悬停一个点看它和谁有关", en: "Linked memories cluster together; isolated ones drift outside. Hover a dot to see its connections" },
