...
const DICT: Record<string, Entry> = {
  ...
  "entryLib.autoRelate": { zh: "一键找关联", en: "Auto-link" },
  "entryLib.autoRelateHint": { zh: "内容相近的记忆自动建关联。机械初版，更准的整理用复制给 AI 整理", en: "Links memories with similar text. Rough first pass — use the AI tidy-up for precision" },
  "entryLib.autoRelateDone": { zh: "找到 {n} 组相近记忆并建立关联", en: "Linked {n} pairs of similar memories" },
